...
function SPAPI_Search(baseUrl)
{
    this.core = new SPAPI_Core();
    var action = this.serviceUrl = baseUrl + '/_vti_bin/Search.asmx';
    
	this.getPortalSearchInfo = function()
	{
		var action = 'http://microsoft.com/webservices/OfficeServer/QueryService/GetPortalSearchInfo';
		var params = [];
		var packet = '<?xml version="1.0" encoding="utf-8"?><soap:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/"><soap:Body><GetPortalSearchInfo xmlns="http://microsoft.com/webservices/OfficeServer/QueryService" /></soap:Body></soap:Envelope>';

		return this.core.executeRequest(this.serviceUrl, action, packet, params);
	}
	
	this.getSearchMetadata = function()
	{
		var action = 'http://microsoft.com/webservices/OfficeServer/QueryService/GetSearchMetadata';
		var params = [];
		var packet = '<?xml version="1.0" encoding="utf-8"?><soap:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/"><soap:Body><GetSearchMetadata xmlns="http://microsoft.com/webservices/OfficeServer/QueryService" /></soap:Body></soap:Envelope>';
	...
	{
		var action = 'http://microsoft.com/webservices/OfficeServer/QueryService/QueryEx';
		var params = ['<![CDATA[' + queryXml + ']]>'];
	...
	this.recordClick = function(clickInfoXml)
	{
		var action = 'urn:Microsoft.Search/RecordClick';
		var params = ['<![CDATA[' + clickInfoXml + ']]>'];
		var packet = '<?xml version="1.0" encoding="utf-8"?><soap:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/"><soap:Body><RecordClick xmlns="urn:Microsoft.Search"><clickInfoXml>{0}</clickInfoXml></RecordClick></soap:Body></soap:Envelope>';
