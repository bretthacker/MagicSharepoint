...
var GLT = {
	...
	topImagePath : "/_catalogs/js/rounded-top2.gif",
	bottomImagePath : "/_catalogs/js/rounded-bottom2.gif",
	...
	init : function (sParent){
		var oDoc=(sParent!=null) ? document.getElementById(sParent) : document;
		if(document.getElementById){
			this.elementsWithTitles = getElementsByAttribute(oDoc, "*", "title");
	...
	applyEvents : function (){
		...
		if(this.interactiveTitle) {
			this.titleElm.onmouseover = GLT.stopTimer;
			//this.currentFadeLevel = this.originalFadeLevel;
			//GLT.setFade;
			this.titleElm.onmouseout = GLT.mouseOutElm;
		}
	...
	showTitle : function (){
		...
		var elA=this.titleTextElm.getElementsByTagName("A");
		if (elA!=null) {
			for(x=0;x<elA.length;x++){
				elA[x].style.color="white";
			}
		}
...
// ---
//following code needs to be added AFTER everything is loaded
